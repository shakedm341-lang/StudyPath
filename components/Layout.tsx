    ...
    <div className="min-h-screen bg-slate-50 flex flex-col md:flex-row font-sans">
      ...
      <aside className="w-full md:w-64 bg-slate-900 text-slate-100 flex flex-col flex-shrink-0">
        ...
        <nav className="flex-1 p-4 space-y-2">
          ...
          <Link to="/plan" className={`flex items-center px-4 py-3 rounded-lg transition-colors ${isActive('/plan')}`}>
            <svg className="w-5 h-5 ml-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <Link to="/stats" className={`flex items-center px-4 py-3 rounded-lg transition-colors ${isActive('/stats')}`}>
            <svg className="w-5 h-5 ml-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
